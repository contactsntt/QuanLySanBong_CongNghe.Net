...
Vậy nên với đề tài này, chúng em xin được phép trình bày cách quản lý sân bóng đá mini, bao gồm cả việc quản lý sân bóng cho thuê và các dịch vụ liên quan, cũng như việc tạo và quản lý hóa đơn thanh toán cho khách hàng.
...
- Thực hiện:
ü	Nhân viên truy cập vào hệ thống và chọn Quản lý đặt sân.
ü	Hệ thống lấy dữ liệu danh sách, hiển thị giao diện danh sách Đặt sân.
ü	Hệ thống hiển thị chức năng nhân viên có thể thực hiện:  tìm kiếm, thêm và xem chi tiết:
...
- Thực hiện:
ü	Quản lý truy cập vào hệ thống và chọn Quản lý sân bóng.
ü	Kiểm tra quyền truy cập.
ü	Hệ thống lấy dữ liệu danh sách, hiển thị giao diện danh sách Sân bóng.
ü	Hệ thống hiển thị chức năng quản lý có thể thực hiện:  tìm kiếm,thêm/sửa, xuất excel, cập nhật loại sân:
...
- Đầu vào: Use Case sử dụng bắt đầu khi quản lý đăng nhập thành công hệ thống.
- Thực hiện:
ü	Quản lý truy cập vào hệ thống và chọn Quản lý dịch vụ.
ü	Kiểm tra quyền truy cập.
ü	Hệ thống lấy dữ liệu danh sách, hiển thị giao diện danh sách Dịch vụ.
ü	Hệ thống hiển thị chức năng quản lý có thể thực hiện:  tìm kiếm,thêm/sửa, xuất excel, cập nhật loại dịch vụ:
...
- Đầu vào: Use Case sử dụng bắt đầu khi quản lý đăng nhập thành công hệ thống.
- Thực hiện:
ü	Quản lý truy cập vào hệ thống và chọn Quản lý nhân viên.
ü	Kiểm tra quyền truy cập.
ü	Hệ thống lấy dữ liệu danh sách, hiển thị giao diện danh sách Nhân viên.
ü	Hệ thống hiển thị chức năng quản lý có thể thực hiện:  tìm kiếm,thêm/sửa, xuất excel, đặt lại mật khẩu và cập nhật quyền truy cập:
...
- Đầu vào: Use Case sử dụng bắt đầu khi quản lý đăng nhập thành công hệ thống.
- Thực hiện:
ü	Quản lý truy cập vào hệ thống và chọn Quản lý khách hàng.
ü	Kiểm tra quyền truy cập.
ü	Hệ thống lấy dữ liệu danh sách, hiển thị giao diện danh sách Khách hàng.
ü	Hệ thống hiển thị chức năng quản lý có thể thực hiện:  tìm kiếm,thêm/sửa, xuất excel:
·	Nếu chọn “Tìm kiếm” thì sự kiện con “Tìm kiếm khách hàng” được thực hiện.
...
- Đầu vào: Use Case sử dụng bắt đầu khi quản lý đăng nhập thành công hệ thống.
- Thực hiện:
ü	Quản lý truy cập vào hệ thống và chọn Quản lý hóa đơn.
ü	Kiểm tra quyền truy cập.
ü	Hệ thống lấy dữ liệu danh sách, hiển thị giao diện danh sách Hóa đơn.
ü	Hệ thống hiển thị chức năng quản lý có thể thực hiện:  tìm kiếm và xem chi tiết:
...
- Đầu vào: Use Case sử dụng bắt đầu khi quản lý đăng nhập thành công hệ thống.
- Thực hiện:
ü	Quản lý truy cập vào hệ thống và chọn Thống kê doanh thu.
ü	Kiểm tra quyền truy cập.
ü	Hệ thống lấy dữ liệu danh sách, hiển thị giao diện Thống kê doanh thu.
ü	Hệ thống hiển thị chức năng quản lý có thể thực hiện:  thống kê và xuất excel:
